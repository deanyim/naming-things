...
export function PauseOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 py-6 [padding-bottom:calc(env(safe-area-inset-bottom)+1.5rem)] [padding-top:calc(env(safe-area-inset-top)+1.5rem)]">
          ...
          <div className="flex w-full flex-col gap-3">
            ...
            {confirmEnd ? (
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="min-h-12 flex-1 rounded-lg border border-gray-300 px-4 py-3 font-medium text-gray-700 transition hover:bg-gray-100"
                  >
                    cancel
                  </button>
                  <button
                    ...
                    className="min-h-12 flex-1 rounded-lg bg-red-600 px-4 py-3 font-medium text-white transition hover:bg-red-700 disabled:opacity-50"
                  >
              ...
              <button
                ...
                className="min-h-12 w-full rounded-lg border border-red-300 px-4 py-3 font-medium text-red-600 transition hover:bg-red-50"
              >
                end game
              </button>
            )}
